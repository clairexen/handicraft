...
@click.option('-F', 'F', default=8, help="number of block inputs")           # increase for more complex routing
@click.option('-N', 'N', default=6, help="number of block outputs")          # increase for laeger designs with simpler routing
