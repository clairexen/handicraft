...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
! Changes by Clifford Wolf for the C-Wrapper:
!   - Substituted 'nout' with '*' in all write() calls
!     .. now nout > 0 means write to stdout and nout <= 0 means silence
!   - Also invoke 'call flush()' before leaving LSMR
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
