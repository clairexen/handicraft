...
- **`encode`** – identical to `normal` except we run the Transformer in encoder mode (no causal masking) to measure the gap between bidirectional and autoregressive attention.
