...
3. **Context propagation.** The `n_layer` sampler outputs are averaged, squashed with `tanh`, and normalized once (default post-avg) to form the single context vector for the next position—nothing else persists across time.
