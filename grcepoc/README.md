...
This mechanism creates an explicit channel for next tokens context without interfering with self-attention capacity. Because the context vector is the sole cross-time carrier, we expect it to split into two behavioral bands:
