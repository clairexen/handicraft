...
class Settings:
    ...
    # The grce_cli_args() return value, if this Settings
    # instance was generated by grce_settings_from_cli_args().
    # A few minor/experimental cli switches aren't imported into
    # Settings fields and thus are only accessible via this.
...
def settings_from_cli_args(args: argparse.Namespace) -> Settings:
    settings = Settings(
        # Preserve CLI args
        cli_args=args,
        ...
        detach_span=args.detach_span,
        detach_context=not args.no_detach_ctx,
        detach_layer=args.detach_layer,
    )
    return settings
