...
- **Parameter dominance:** ignoring embeddings, the stack costs `~12 * n_layer * n_embd^2`, and the GRCE path adds `~4 * n_embd * (n_embd + n_grce)` (shared concat/projectors dominate).
