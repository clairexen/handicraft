...
def print_help():
    ...
    print("            (for gears to match, their modules must be equal. the gears")
    print("            working diameter is [number of teeth] times [module])")
    print("")
    print(" -c X ..... clearance (default = 0.0)")
    print("            (move the gear bottom land down by this number of millimeters)")
    print("")
    print(" -a X ..... addendum offset (default = 0.0)")
    print("            (move the gear top land up by this number of millimeters by")
    ...
    print("            (move the flanks inside by this number of millimeters.)")
    print("")
